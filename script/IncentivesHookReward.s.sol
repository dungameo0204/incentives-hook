...
contract IncentivesHookRewardScript is Script {
    ...
    function run() public {
        ...
        console.log("TokenA balance:", tokenA.balanceOf(SWAP_ROUTER));
        console.log("TokenB balance:", tokenB.balanceOf(SWAP_ROUTER));
        ...
        uint256 rewardLP1 = hook.earned(key, activeLower, activeUpper, MODIFY_LIQUIDITY_ROUTER, saltlp1);
        uint256 rewardLP2 = hook.earned(key, unactiveLower, unactiveUpper, MODIFY_LIQUIDITY_ROUTER, saltlp2);
